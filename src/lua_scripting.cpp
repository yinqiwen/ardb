...
namespace ardb
{
	...
	static char *redisProtocolToLuaType_Int(lua_State *lua, char *reply);
	static char *redisProtocolToLuaType_Bulk(lua_State *lua, char *reply);
	static char *redisProtocolToLuaType_Status(lua_State *lua, char *reply);
	static char *redisProtocolToLuaType_Error(lua_State *lua, char *reply);
	static char *redisProtocolToLuaType_MultiBulk(lua_State *lua, char *reply);

	static char *redisProtocolToLuaType(lua_State *lua, char* reply)
	{
		char *p = reply;
